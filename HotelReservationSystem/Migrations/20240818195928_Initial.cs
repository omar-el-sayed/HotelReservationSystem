        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RoomType = table.Column<string>(type: "varchar(10)", nullable: false),
                    ...
                    AvailableStatus = table.Column<string>(type: "varchar(20)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PictureRooms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PictureRooms_Rooms_RoomId",
                        column: x => x.RoomId,
